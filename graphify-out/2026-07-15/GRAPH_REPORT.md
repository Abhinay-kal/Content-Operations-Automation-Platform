...
## Corpus Check
- 266 files · ~136,909 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1558 nodes · 1982 edges · 179 communities (70 shown, 109 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `38e6d9da`
...
## Communities (179 total, 109 thin omitted)
...
Cohesion: 0.09
Nodes (8): BackendIdentity, ConnectionStatus, PluginIdentity, PresenceStatus, RegistrationStatus, SecretStoreInterface, ConfigService, SettingsRepository
...
Cohesion: 0.11
Nodes (12): AuditPromptBuilder, { ContentUnavailableError, InvalidProjectContentError }, { FailureClassifier }, fs, path, { PROJECT_STATUSES }, RewritePromptBuilder, { WORKER_STATES } (+4 more)
...
## Knowledge Gaps
- **390 isolated node(s):** `express`, `crypto`, `http`, `data`, `options` (+385 more)
...
- **Why does `JobService` connect `Jobservice Components` to `Community 82`?**
...
- **Why does `ProjectService` connect `Projectservice Components` to `Migrations Components`, `Community 84`, `Bootstrapmanager Components`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **What connects `express`, `crypto`, `http` to the rest of the system?**
