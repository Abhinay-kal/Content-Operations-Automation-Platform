# Graph Report - Content-Operations-Automation  (2026-07-15)

## Corpus Check
- 267 files · ~137,020 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1559 nodes · 1985 edges · 171 communities (65 shown, 106 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dea1646e`
...
## Communities (171 total, 106 thin omitted)
...
Cohesion: 0.07
Nodes (11): BackendIdentity, ConnectionStatus, HandshakeResult, PluginIdentity, PresenceStatus, RegistrationResult, RegistrationStatus, SecretStoreInterface (+3 more)
...
Cohesion: 0.11
Nodes (15): ConnectionResult, DiagnosticsService, HealthService, HeartbeatResult, LoggerInterface, ConnectionService, HeartbeatService, NullLogger (+7 more)
...
Cohesion: 0.23
Nodes (8): OverviewDto, Dashboard(), KPICard(), KPICardProps, KPIGrid(), QueueWidget(), useJobs(), useOverview()
...
Cohesion: 0.22
Nodes (8): createWordPressRoutes(), express, { BootstrapManager }, { createApp }, main(), createApp(), createQueueRouter, express
...
Cohesion: 0.14
Nodes (14): ApiError, ApiErrorResponse, ApiResponse, AuditIssue, JobDto, ProjectDto, ProjectFilters, ReviewDetailDto (+6 more)
...
Cohesion: 0.09
Nodes (26): RewriteDto, ReviewWidget(), ReviewDto, ReviewFilters, useReviewAction(), useReviewAssign(), useReviewDetails(), useReviewQueue() (+18 more)

### Community 167 - "Community 167"
Cohesion: 0.05
Nodes (22): AdminModule, Menu, OverviewPage, SettingsPage, BackendClient, BackendClient, ServiceContainer, CompatibilityService (+14 more)
...
Cohesion: 0.47
Nodes (4): apiClient(), EventFeed(), EventDto, useEvents()
...
## Knowledge Gaps
- **391 isolated node(s):** `express`, `ConfigService`, `crypto`, `http`, `data` (+386 more)
...
- **What connects `express`, `ConfigService`, `crypto` to the rest of the system?**
